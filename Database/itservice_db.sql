...
CREATE TABLE `tbl_ipc` (
  ...
  `ipc_address` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `ipc_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `ipc_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_thai_520_w2 NOT NULL
...
--
ALTER TABLE `tbl_ipc`
  MODIFY `ipc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
